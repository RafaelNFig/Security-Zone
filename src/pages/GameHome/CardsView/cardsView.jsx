...
function CardsView() {
  ...
  // 🔵 Buscar cartas da API (mantido do original)
  useEffect(() => {
  ...
  // 🔵 Filtrar cartas (mantido do original)
  ...
  // ✅ Só front: evita Tailwind dinâmico (mantém a mesma UI e evita sumir estilo no build)
  const navBtnClass =
  ...
  return (
    <div className="relative flex w-screen h-screen bg-[#000814] text-white select-none overflow-hidden">
      ...
      >
            ...
            >
              <div className="flex items-center gap-4 min-w-0">
                ...
                >
                  ...
                  <option value="attack" className="bg-[#000814] text-slate-100">
                    Attack
                  </option>
                  <option value="defense" className="bg-[#000814] text-slate-100">
                    Defense
                  </option>
                  <option value="magic" className="bg-[#000814] text-slate-100">
                    Magic
                  </option>
                </select>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="p-2 rounded-xl bg-white/5 border border-white/10 hover:bg-red-500/15 transition">
        ...
        {page === "create" && (
          <CreateDeck onCreate={handleCreateDeck} onBack={() => setPage("decks")} />
        )}
      </main>
    </div>
  );
