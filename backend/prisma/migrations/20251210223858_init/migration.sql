...
CREATE TABLE `PLAYER` (
    ...
    `PL_FIREBASE_UID` VARCHAR(255) NULL,
    `PL_AUTH_PROVIDER` VARCHAR(50) NULL,
    ...
    `PL_ACTIVE_DECK_COUNT` INTEGER NOT NULL DEFAULT 0,
    ...
    UNIQUE INDEX `PLAYER_PL_FIREBASE_UID_key`(`PL_FIREBASE_UID`),
    PRIMARY KEY (`PL_ID`)
...
CREATE TABLE `CARDS` (
    ...
    `CD_MAX_IN_DECK` INTEGER NOT NULL DEFAULT 3,
    `CD_MAX_IN_COLLECTION` INTEGER NOT NULL DEFAULT 4,
...
CREATE TABLE `PLAYER_CARD` (
    ...
    INDEX `PLAYER_CARD_CARDS_CD_ID_fkey`(`CARDS_CD_ID`),
...
CREATE TABLE `DECK` (
    ...
    UNIQUE INDEX `DECK_PLAYER_PL_ID_DECK_NAME_key`(`PLAYER_PL_ID`, `DECK_NAME`),
    PRIMARY KEY (`DECK_ID`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `DECK_CARD` (
    ...
    `CARDS_CD_ID` INTEGER NOT NULL,
    `DECK_CD_QUANTITY` INTEGER NOT NULL DEFAULT 1,
    `DECK_CD_POSITION` INTEGER NULL,

    INDEX `DECK_CARD_DECK_ID_idx`(`DECK_ID`),
    INDEX `DECK_CARD_CARDS_CD_ID_idx`(`CARDS_CD_ID`),
...
CREATE TABLE `MATCH` (
    ...
    INDEX `MATCH_MT_WINNER_ID_fkey`(`MT_WINNER_ID`),
    PRIMARY KEY (`MT_ID`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `MATCH_PLAYER` (
    ...
    INDEX `MATCH_PLAYER_DECK_USED_ID_fkey`(`DECK_USED_ID`),
    INDEX `MATCH_PLAYER_PLAYER_ID_fkey`(`PLAYER_ID`),
